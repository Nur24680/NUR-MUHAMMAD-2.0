...
module.exports.onLoad = async () => {
  ...
  const path = resolve(__dirname, 'cache', 'IMG-20250615-WA0013.jpg');
...
async function makeImage({ one, two }) {
  ...
  let hon_img = await jimp.read(__root + "/IMG-20250615-WA0013.jpg");
...
module.exports.run = async function ({ event, api }) {
  ...
  if (!mention) return api.sendMessage("👉 একজনকে Tag করুন!", threadID, messageID);
